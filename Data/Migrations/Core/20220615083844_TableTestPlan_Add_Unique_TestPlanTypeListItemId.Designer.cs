...
namespace Data.Migrations.core
{
    ...
    [Migration("20220615083844_TableTestPlan_Add_Unique_TestPlanTypeListItemId")]
    partial class TableTestPlan_Add_Unique_TestPlanTypeListItemId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Environment", b =>
                {
                    ...
                    b.HasIndex("EnvironmentName", "ProjectId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.ProjectModule", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "ModuleName", "ParentProjectModuleId", "ProjectModuleListItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.ProjectStarred", b =>
                {
                    b.Property<int>("ProjectStarredId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ProjectStarredId"));
            ...
            modelBuilder.Entity("Entities.TestPlan", b =>
                {
                    ...
                    b.HasIndex("ParentTestPlanId", "TestPlanName", "ProjectId", "TestPlanTypeListItemId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.TestRunTestCaseStepHistoryDocument", b =>
                {
                    b.Property<int>("TestRunTestCaseStepHistoryDocumentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("TestRunTestCaseStepHistoryDocumentId"));
                    ...
                    b.HasKey("TestRunTestCaseStepHistoryDocumentId");

                    b.HasIndex("DocumentId");

                    b.HasIndex("TestRunTestCaseStepHistoryId", "DocumentId")
                        .IsUnique();

                    b.ToTable("TestRunTestCaseStepHistoryDocument");
                });
            ...
            modelBuilder.Entity("Entities.TestRunTestCaseStepHistoryDocument", b =>
                {
                    ...
                    b.HasOne("Entities.TestRunTestCaseStepHistory", "ProjectModule")
                        .WithMany()
                        .HasForeignKey("TestRunTestCaseStepHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
